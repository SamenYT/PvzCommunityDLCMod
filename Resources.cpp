...
Image* Sexy::IMAGE_ALMANAC_GROUNDNIGHTROOF;
...
bool Sexy::ExtractDelayLoad_AlmanacResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_ALMANAC_GROUNDNIGHTROOF = aMgr.GetImageThrow("IMAGE_ALMANAC_GROUNDNIGHTROOF");
...
Image* Sexy::IMAGE_BIG_PUFF_PARTICLE;
Image* Sexy::IMAGE_REANIM_MORTAR_BODY_2;
...
Image* Sexy::IMAGE_REANIM_VIOLET_PADDLE;
...
Image* Sexy::IMAGE_PROJECTILE_ZAP;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager *theManager)
{
	...
	try
	{
		...
		IMAGE_BIG_PUFF_PARTICLE = aMgr.GetImageThrow("IMAGE_BIG_PUFF_PARTICLE");
		IMAGE_REANIM_MORTAR_BODY_2 = aMgr.GetImageThrow("IMAGE_REANIM_MORTAR_BODY_2");
		...
		IMAGE_REANIM_VIOLET_PADDLE = aMgr.GetImageThrow("IMAGE_REANIM_VIOLET_PADDLE");
		...
		IMAGE_PROJECTILE_ZAP = aMgr.GetImageThrow("IMAGE_PROJECTILE_ZAP");
	}
	catch(ResourceManagerException&)
	{
		return false;
...
static void* gResources[] =
{
	...
	&IMAGE_BIG_PUFF_PARTICLE,
	&IMAGE_REANIM_MORTAR_BODY_2,
	&SOUND_AWOOGA,
	&SOUND_BLEEP,
	&SOUND_BUZZER,
	&SOUND_CHOMP,
...
const char* Sexy::GetStringIdById(int theId)
{
	switch(theId)
	{
		...
		case IMAGE_REANIM_VIOLET_PADDLE_ID: return "IMAGE_REANIM_VIOLET_PADDLE";
		...
		case IMAGE_BIG_PUFF_PARTICLE_ID: return "IMAGE_BIG_PUFF_PARTICLE";
		case IMAGE_REANIM_MORTAR_BODY_2_ID: return "IMAGE_REANIM_MORTAR_BODY_2";
		...
		case IMAGE_ALMANAC_GROUNDNIGHTROOF_ID: return "IMAGE_ALMANAC_GROUNDNIGHTROOF";
		...
		case IMAGE_RHYTHM_GRID_ID: return "IMAGE_CREDITS_ZOMBIENOTE";
		case IMAGE_PROJECTILE_ZAP_ID: return "IMAGE_CREDITS_PLAYBUTTON";
		default: return "";
	}
}
