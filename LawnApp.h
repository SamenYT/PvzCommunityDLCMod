...
public:
	...
	//void							DoNewModOptions(bool theFromGameSelector);
	void							DoRegister();
	...
	/*inline*/ bool					IsBigTroubleLevel();
	/*inline*/ bool					IsDarkLevel();
	...
	/*inline*/ bool					HasBeatenChallengeHardmode(GameMode theGameMode);
	...
	int								GetNumTrophiesHardmode(ChallengePage thePage);
	/*inline*/ bool					EarnedGoldTrophy();
	/*inline*/ bool					EarnedDiamondTrophy();
	...
	/*inline*/ bool					IsPuzzleMode2();
	/*inline*/ bool					IsMinigamePage2();
	...
	/*inline*/ int					TrophiesNeedForDiamondSunflower();
	...
	virtual void					SwitchScreenMode(bool wantWindowed, bool is3d, bool wantHardmode, bool wantCoop, bool force = false);
