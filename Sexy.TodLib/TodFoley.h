...
enum FoleyType
{
    ...
    FOLEY_BELL,
    FOLEY_SHOOTINGSTAR,
    FOLEY_BUSH_RUSTLING1,
    FOLEY_BUSH_RUSTLING2,
    FOLEY_BUSH_RUSTLING3,
    FOLEY_ELECTRIC2,
    FOLEY_ELECTRIC3,
    FOLEY_BUSH_DESTROYED1,
    FOLEY_BUSH_DESTROYED2,
    FOLEY_BUSH_DESTROYED3,
    FOLEY_HUNTER_SHOOT,
    FOLEY_SKELETON_DIE,
