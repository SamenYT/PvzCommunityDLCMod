...
public:
	...
	PlayerController*				mPlayer2;
	//The save file ends before here
	bool							mPaused;												//+0x164
	...
	int								mIceTimerAge[MAX_GRID_SIZE_Y];								
	...
	bool							mHeldSpeeding = false;
	bool							mSpeedIsOn = false;
	int								mBoardAge;
	bool							mCobActivated;
	int								mGridXCob;
	int								mGridYCob;
	int								mDummyCounter;
	int								mDummyCounterEnemy;
	int								mRageDelay;
...
public:
	...
	int								CountBrainBeingCollected();
	void							DrawGameObjects(Graphics* g);
	void							CauseBloodMoon();
	void							CauseGlitch();
	void							DeactivateBloodMoon();
	void							ClearCursor();
	...
	/*inline*/ void					AddBrainMoney(int theAmount);
	bool							TakeSunMoney(int theAmount);
	/*inline*/ bool					CanTakeSunMoney(int theAmount);
	bool							TakeBrainMoney(int theAmount);
	/*inline*/ bool					CanTakeBrainMoney(int theAmount);
	...
	/*inline*/ bool					StageIsMoon();
	/*inline*/ bool					StageIsZombotany();
	...
	void							DoFwooshChilly(int theRow, int theColumn);
	void							UpdateFwoosh();
	...
	/*inline*/ GridItem*			AddAWoodLog(int theGridX, int theGridY);
	/*inline*/ GridItem*			AddABush(int theGridX, int theGridY);
	...
	/*inline*/ GridItem*			GetWoodLogAt(int theGridX, int theGridY);
	/*inline*/ GridItem*			GetBushAt(int theGridX, int theGridY);
	...
	Plant*							GetPlantAt(int theGridX, int theGridY);
	...
	/*inline*/ void				    IncreaseTargetCounter();
