...
void SyncBoard(SaveGameContext& theContext, Board* theBoard)
{
	...
	//theContext.SyncBytes(theBoard->mPlayer2, sizeof(PlayerController));
	// We need to save data where the player left of incase they want to resume. I remember you dint need this?
	//maybe not rn, but it would be good to have I guess
