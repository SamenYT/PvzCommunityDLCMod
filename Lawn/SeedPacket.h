...
public:
    ...
    static bool         IsZombiePack(SeedType theSeedType);
    static bool         IsLegacyPack(SeedType theSeedType);
    static bool         IsLegacyNotAffectedbySuddenDeath(SeedType theSeedType);
};
