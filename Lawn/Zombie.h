...
public:
    ...
    int                             mCounterToDeath;
    bool                            mSpawnedAfterEating;
    int                             mCountYTransition;
    int                             mStartingHealth;
    int                             mAttackType;
    int                             mHealCounter;
    int                             mShrinkCounter;
    ...
    int                             XOrig;
    int                             mMoveTimer;
    bool                            mInPoolAfterShrink;
    bool                            mHasBeenStunned;
    int                             mStunRemoveCounter;
    int                             mAbilityCounter;
    bool                            mIsShrunken;
    int                             mGargSquishCounter;
    bool                            mIsThrown;
    int                             mBoneHealth;
    int                             mRespawnCounter;
    bool                            mIsShrinking;
...
public:
    ...
    void                            BossDestroyIceball(int theCol);
    void                            DiggerLoseAxe();
    ...
    void                            UpdatePotatoHead();
    void                            UpdateCherryHead();
    ...
    void                            DoElectroDamage(Zombie* smallest);
    void                            UpdateIceZombie();
    void                            UpdateChomperZombie();
    void                            UpdateZombieSunflower();
    void                            UpdateGladiantuarBoss();
    void                            UpdateVampireZombie();
    void                            UpdateLeafBlowerZombie();
    void                            UpdateZombieSkeleton();
    static /*inline*/ void          SetupGargReanimLayers(Reanimation* aReanim, ZombieType theZombieType);
    static bool                     IsImmune(ZombieType theZombietype);
    void                            AnimateTargetZombie();
};
