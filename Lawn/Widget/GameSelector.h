...
private:
    enum
    {
        ...
        GameSelector_Versus = 111,
        GameSelector_Modcredits = 112,
        GameSelector_Changelogs = 113,
        GameSelector_Disclaimer = 114
    };
...
public:
    ...
    NewLawnButton*              mVersusModeButton;            
    NewLawnButton*              mModCreditsButton;
    NewLawnButton*              mChangeLogsButton;
    NewLawnButton*              mDisclaimerButton;
    NewLawnButton*              mChangeUserButton;          //+0xB8   
    NewLawnButton*              mNewVersusModeButton;
