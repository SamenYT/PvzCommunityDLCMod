...
enum MagnetItemType
{
    ...
    MAGNET_GLADIANTUAR_HELMET_1,
    MAGNET_GLADIANTUAR_HELMET_2,
    MAGNET_GLADIANTUAR_HELMET_3,
    MAGNET_ITEM_PAIL_GIGA_1,
    MAGNET_ITEM_PAIL_GIGA_2,
    MAGNET_ITEM_PAIL_GIGA_3
};
...
public:
    ...
    bool                    mStopAnimation;
    bool                    mIsBackwards;
    int                     mChardGuardLeafs;
    int                     mApliflowerCounter;
    bool                    mCycle;
    int                     mMoveOffset;
    int                     mStunnedWeb;
    int                     mStunned;
...
public:
    ...
    GridItem*               FindTargetGridItem(int theRow);
    void                    Die();
    ...
    void                    FreezeRow(int theRow);
    void                    BurnColumn(int theColumn);
    void                    IceZombies();
    ...
    void                    LaunchStarFruitReverse();
    void                    LaunchCactusKing();
    void                    LaunchSeaFruit();
    void                    LaunchReed();
    bool                    FindStarFruitTarget();
    bool                    FindStarFruitTargetReverse();
    bool                    FindSeaFruitTarget();
    bool                    FindReedTarget();
    void                    UpdateChomper();
    void                    UpdateBonkChoy();
    void                    UpdateAmpliflower();
    void                    UpdateChardGuard();
    ...
    void                    UpdateBraveShroom();
    void                    UpdateOakArcher();
    int                     DistanceToClosestZombie();
    void                    UpdateSpikeweed();
    void                    UpdateThornmoss();
    void                    MagnetShroomAttactItem(Zombie* theZombie);
    void                    UpdateSunShroom();
    void                    UpdateBowling();
    void                    AnimatePumpkin();
    void                    AnimateFireshroom();
    void                    AnimateChardGuard();
    void                    AnimateGrave();
    void                    UpdateBlover();
    void                    UpdateCactus();
    void                    StarFruitFire();
    void                    StarFruitFireReverse();
    void                    KingCactusFire();
    void                    SeaStarFruitFire();
    void                    ReedFire();
    void                    ElectricuteZombie();
    ...
    void                    PlayCustomIdleAnim(float theRate, const char* theTrackName);
