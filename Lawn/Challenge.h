...
public:
    ...
    void                    SpawnBushAt(int theGridX, int theGridY);
    ...
    static /*inline*/ bool  IsVersusSeedType(SeedType theSeedType);
    static /*inline*/ bool  IsNonGroundSeedType(ZombieType theZombieType);
...
extern SeedType gArtChallengeSeaStarFruit[6][9];

class ZombieAllowedLevels
{
public:
    ZombieType                      mZombieType;
    int                             mAllowedOnLevel[70]; //teleport
};
