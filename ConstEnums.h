...
enum ChallengePage
{
    ...
    CHALLENGE_PAGE_SURVIVAL2 = 1,
    CHALLENGE_PAGE_CHALLENGE = 2,
    CHALLENGE_PAGE_CHALLENGE2 = 3,
    CHALLENGE_PAGE_CHALLENGE3 = 4,
    CHALLENGE_PAGE_CHALLENGE4 = 5,
    CHALLENGE_PAGE_VERSUS = 6,
    CHALLENGE_PAGE_LIMBO = 7,
    CHALLENGE_PAGE_PUZZLE = 8,
    CHALLENGE_PAGE_PUZZLE2 = 9,
    CHALLENGE_PAGE_PUZZLE3 = 10,
    CHALLENGE_PAGE_CREDITS = 11,
    CHALLENGE_PAGE_DISCLAIMER = 12,
    MAX_CHALLANGE_PAGES = 13
};
enum ChallengeState
{
...
enum GameMode
{
    ...
    GAMEMODE_CHALLENGE_SEASTAR,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_3,
    GAMEMODE_CHALLENGE_BOMBALL,
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_3,
    GAMEMODE_CHALLENGE_ZOMBIESVSZOMBIES,
    GAMEMODE_CHALLENGE_GLADIANTUAR,
    GAMEMODE_SCARY_POTTER_11,
    GAMEMODE_SCARY_POTTER_12,
    GAMEMODE_SCARY_POTTER_13,
    GAMEMODE_SCARY_POTTER_14,
    GAMEMODE_SCARY_POTTER_15,
    GAMEMODE_SCARY_POTTER_16,
    GAMEMODE_SCARY_POTTER_17,
    GAMEMODE_SCARY_POTTER_18,
    GAMEMODE_SCARY_POTTER_19,
    GAMEMODE_SCARY_POTTER_20,
    GAMEMODE_PUZZLE_I_ZOMBIE_11,
    GAMEMODE_PUZZLE_I_ZOMBIE_12,
    GAMEMODE_PUZZLE_I_ZOMBIE_13,
    GAMEMODE_PUZZLE_I_ZOMBIE_14,
    GAMEMODE_PUZZLE_I_ZOMBIE_15,
    GAMEMODE_PUZZLE_I_ZOMBIE_16,
    GAMEMODE_PUZZLE_I_ZOMBIE_17,
    GAMEMODE_PUZZLE_I_ZOMBIE_18,
    GAMEMODE_PUZZLE_I_ZOMBIE_19,
    GAMEMODE_PUZZLE_I_ZOMBIE_20,
    GAMEMODE_CHALLENGE_RHYTHM_GARLIC,
    GAMEMODE_CHALLENGE_GLITCH,
    GAMEMODE_CHALLENGE_FLIPPED,
    GAMEMODE_CHALLENGE_GIGA,
    GAMEMODE_CHALLENGE_DARK,
    GAMEMODE_CHALLENGE_SMASH,
    GAMEMODE_CHALLENGE_HIGHGROUND,
    GAMEMODE_CHALLENGE_PLANTS_VS_PLANTS,
    GAMEMODE_CHALLENGE_ECLIPSE,
    GAMEMODE_CHALLENGE_WOOD,
    GAMEMODE_CHALLENGE_BORDER,
    GAMEMODE_CHALLENGE_TEST,
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    GAMEMODE_TREE_OF_WISDOM,
    GAMEMODE_CHALLENGE_SNOWPEA,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_4,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_5,
    GAMEMODE_CHALLENGE_VERSUS,
    GAMEMODE_CHALLENGE_VERSUS_FOREST,
    GAMEMODE_CHALLENGE_VERSUS_POOL,
    GAMEMODE_CHALLENGE_VERSUS_NIGHT,
    GAMEMODE_CHALLENGE_VERSUS_FOG,
    GAMEMODE_CHALLENGE_VERSUS_ROOF,
    GAMEMODE_CHALLENGE_VERSUS_MOON,
    GAMEMODE_CHALLENGE_VERSUS_OLD,
    NUM_GAME_MODES
};
enum GameObjectType
{
...
enum HelmType
{
    ...
    HELMTYPE_ICE = 11,
    HELMTYPE_GLADIANTUAR = 12,
    HELMTYPE_PAIL_GIGA = 13
};
enum LawnMowerState
{
    MOWER_ROLLING_IN = 0,
...
enum ParticleEffect
{
    ...
    PARTICLE_ELECTRIC,
    PARTICLE_GLADIANTUAR_HELMET,
    PARTICLE_LAWNMOWER_EXPLOSION,
    PARTICLE_LAWNMOWER_EXPLOSION_TRICKED_OUT,
    PARTICLE_BUSH,
    PARTICLE_ZOMBIE_BUSH,
    PARTICLE_FROSTCLOUD,
    PARTICLE_SKELETON_DEATH,
    PARTICLE_ZOMBIE_ICE_HEAD,
...
enum PlantingReason
{
    ...
    PLANTING_NOT_PASSED_LINE_VERSUS,
    PLANTING_NOT_PASSED_LINE_VERSUS_PLANTS,
...
enum ProjectileMotion
{
    ...
    MOTION_HOMING = 9,   // 追踪
    MOTION_PUFF_BACKWARDS = 10,   
    MOTION_THREEPEATER_BACKWARDS = 11   
};
enum ProjectileType
{
    PROJECTILE_PEA = 0,   // 豌豆
    ...
    PROJECTILE_PLASMABALL = 7,
    PROJECTILE_ICEQUEEN = 8,
    PROJECTILE_ELECTRIC = 9,
    PROJECTILE_STAR = 10,   // 星星
    PROJECTILE_SEASTAR = 11,
    PROJECTILE_SPIKE = 12,   // 尖刺
    PROJECTILE_BASKETBALL = 13,   // 篮球
    PROJECTILE_KERNEL = 14,  // 玉米粒
    PROJECTILE_COBBIG = 15,  // 玉米加农炮
    PROJECTILE_BUTTER = 16,  // 黄油
    PROJECTILE_ZOMBIE_PEA = 17,  // 僵尸豌豆
    PROJECTILE_PEPPER = 18,
    PROJECTILE_ZOMBIE_SNOWPEA = 19,
    PROJECTILE_ZOMBIE_FLAMEPEA = 20,
    PROJECTILE_ARROW = 21,
    PROJECTILE_BEE = 22,
    PROJECTILE_SHOOTING_STAR = 23,
    PROJECTILE_BIG_PUFF = 24,
    NUM_PROJECTILES = 25,
    PROJECTILE_REED_ZAP
};
enum ReanimationType
{
    ...
    REANIM_TORCHWOOD,
        ...
        REANIM_HEAL_PURPLE,
        REANIM_WOOD_CHIPPER,
        REANIM_LEMONADE_LEGACY,
        REANIM_DUMMY,
        REANIM_SHOOTINGSTAR,
        REANIM_PROJECTILE_SHOOTINGSTAR,
        REANIM_MIRAGE_MALLOW,
        REANIM_ZOMBIE_CHARRED_GIGA_GARGANTUAR,
        REANIM_ZOMBIE_CHARRED_LEAFBLOWER,
        REANIM_READY_SET_FIGHT,
        REANIM_READY_SET_ZOMBIE,
        REANIM_ZOMBIE_CHARRED_BUSH,
        REANIM_TITLESCREEN,
        REANIM_PLASMA_FIRE,
        REANIM_SKELETON,
        REANIM_CHARRED_SKELETON,
        REANIM_LUMESHROOM,
        REANIM_MORTARSHROOM,
        REANIM_BLOODORANGE,
        REANIM_VOLTSHROOM,
        ...
        REANIM_ZOMBIE_CHARRED_SCARECROW,
        REANIM_AIRRAID_POT,
        REANIM_BLOODSPLASH,
    NUM_REANIMS
};
...
enum RenderLayer
{
    ...
    RENDER_LAYER_OBJECTS        = 600000,
    RENDER_LAYER_COIN_BANK      = 700000,
...
enum SeedType
{
    ...
    SEED_SHRINK = 53,
    SEED_LEMON_NADE = 54,
    SEED_AMPLI_FLOWER = 55,
    SEED_GATLINGPEA = 56,
    SEED_TWINSUNFLOWER = 57,
    SEED_GLOOMSHROOM = 58,
    SEED_CATTAIL = 59,
    SEED_WINTERMELON = 60,
    SEED_GOLD_MAGNET = 61,
    ...
    SEED_FLAMEPEA = 73,
    SEED_PEPPER = 74,
    SEED_PICKLEPEPPER = 75,
    SEED_FIRESHROOM = 76,
    SEED_WATERPOT = 77,
    SEED_PINKSTAR = 78,
    SEED_CHILLYPEPPER = 79,
    SEED_EPEA = 80,
    SEED_PLASMAPEA = 81,
    SEED_SHOOTINGSTAR = 82,
    SEED_EXPLODE_O_NUT = 83,
    SEED_GIANT_WALLNUT = 84,
    SEED_SPROUT = 85,
    SEED_LEFTPEATER = 86,
    SEED_ICENUT = 87,
    SEED_VERSUS_NORMAL = 88,
    SEED_GRAVE = 89,
    SEED_VERSUS_CONEHEAD = 90,
    SEED_VERSUS_POLE = 91,
    SEED_VERSUS_BUCKET = 92,
    SEED_VERSUS_NEWSPAPER = 93,
    SEED_VERSUS_SCREENDOOR = 94,
    SEED_VERSUS_FOOTBALL = 95,
    SEED_VERSUS_DANCER = 96,
    SEED_VERSUS_FLAG = 97,
    SEED_VERSUS_ZOMBONI = 98,
    SEED_VERSUS_JACK = 99,
    SEED_VERSUS_BALLOON = 100,
    SEED_VERSUS_DIGGER = 101,
    SEED_VERSUS_POGO = 102,
    SEED_VERSUS_BUNGEE = 103,
    SEED_VERSUS_LADDER = 104,
    SEED_VERSUS_CATAPULT = 105,
    SEED_VERSUS_GARGANTUAR = 106,
    SEED_VERSUS_TRASHCAN = 107,
    SEED_VERSUS_VAMPIRE = 108,
    SEED_VERSUS_SCARECROW = 109,
    SEED_VERSUS_FOOTBALL_GIGA = 110,
    SEED_VERSUS_GLADIANTUAR = 111,
    SEED_VERSUS_GARGANTUAR_GIGA = 112,
    SEED_VERSUS_IMP = 113,
    SEED_VERSUS_SNORKEL = 114,
    SEED_VERSUS_DOLPHIN = 115,
    SEED_VERSUS_BACKUP = 116,
    SEED_VERSUS_ZOMBOSS = 117,
    SEED_VERSUS_LEAFBLOWER = 118,
    SEED_VERSUS_LUMBERJACK = 119,
    SEED_VERSUS_FISHERMAN = 120,
    SEED_VERSUS_HUNTER = 121,
    SEED_VERSUS_ICE = 122,
    SEED_VERSUS_GLADIANTUAR_GIGA = 123,
    SEED_REVERSE_PEASHOOTER = 124,
    SEED_REVERSE_SNOWPEA = 125,
    SEED_REVERSE_CHOMPER = 126,
    SEED_REVERSE_PUFFSHROOM = 127,
    SEED_REVERSE_FUMESHROOM = 128,
    SEED_REVERSE_CACTUS = 129,
    SEED_REVERSE_STARFRUIT = 130,
    SEED_REVERSE_THREEPEATER = 131,
    SEED_DUMMY = 132,
    SEED_FLYING_GARLIC = 133,
    NUM_SEED_TYPES,
    ...
    SEED_ZOMBIE_IMP,
    SEED_ZOMBIE_SCARECROW,
    SEED_ZOMBIE_GIGA_FOOTBALL,
    SEED_ZOMBIE_ICE,
    SEED_ZOMBIE_SNORKEL,
    SEED_ZOMBIE_ZOMBOSS,
    NUM_SEEDS_IN_CHOOSER = 128,
    SEED_NONE = -1
};
enum ShieldType
{
...
enum StoreItem
{
    ...
    STORE_ITEM_PLANT_ICYFUME,
    STORE_ITEM_PLANT_SUPERCHOMP,
    STORE_ITEM_PLANT_FLAMEWOOD,
    STORE_ITEM_PLANT_ICEQUEEN,
    STORE_ITEM_PLANT_VINENUT,
    STORE_ITEM_PLANT_THORNMOSS,
    STORE_ITEM_PLANT_BRAVESHROOM,
    STORE_ITEM_PLANT_ECACTUS,
    STORE_ITEM_PLANT_IMITATER,
    STORE_ITEM_PLANT_FIRE_PEASHOOTER,
    STORE_ITEM_PLANT_PEPPERPULT,
    STORE_ITEM_PLANT_CHILLYPEPPER,
    STORE_ITEM_PLANT_WATERPOT,
    STORE_ITEM_PLANT_FIRESHROOM,
    STORE_ITEM_PLANT_SEASTAR,
    STORE_ITEM_PLANT_PICKLEDPEPPER,
    STORE_ITEM_PLANT_EPEA,
    STORE_ITEM_PLANT_PLASMAPEA,
    STORE_ITEM_PLANT_SHOOTINGSTAR,
...
enum StorePages
{
    ...
    STORE_PAGE_ZEN1 = 2,
    STORE_PAGE_ZEN2 = 3,
    STORE_PAGE_PLANT_UPGRADES2 = 4,
    STORE_PAGE_PLANT_PURCHASES = 5,
    NUM_STORE_PAGES = 6
};
enum TodCurves
{
...
enum ZombiePhase
{
    ...
    PHASE_GUN_SHOOTING,
    PHASE_BONE_PILE,
    PHASE_GIGA_GLAD_MOVING,
    PHASE_GIGA_GLAD_STATIONARY
};
enum ZombieType
{
    ZOMBIE_INVALID = -1,
    ...
    ZOMBIE_SNOWPEA_BOSS,
    ZOMBIE_GIGA_BASIC,
    ZOMBIE_GIGA_CONEHEAD,
    ZOMBIE_GIGA_BUCKETHEAD,
